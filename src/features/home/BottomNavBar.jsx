...
const BottonNavBar = () => {
    ...
    return (
        <div className=' hidden lg:flex justify-center w-full bg-dfs dark:bg-lfs pr-72 py-2'>

            <ul className='botton-bar flex items-center gap-5 text-lfp dark:text-dfp max-w-7xl'>
                {
                    categores.map((cat) => (
